...
public class ExtremeUno {
    ...
    public ExtremeUno(int numPlayers, String gameMode) {
        ...
        // Discard Pile
        discardPile = new ExtremeUnoCollection();
    ...
    private int selectCardToPlay(ExtremeUnoCollection playerHand, UnoCard topCard) {
        Scanner scanner = new Scanner(System.in);
    ...
    public void playTurn(int player) {
        ...
        ExtremeUnoCollection playerHand = hands.get(player);
    ...
    private boolean canPlayAnyCard(ExtremeUnoCollection playerHand, UnoCard topCard) {
        for (int i = 0; i < playerHand.getNumCards(); i++) {
